Feature: Affiliate Portal | Login Module

    Checking login functionality

    Background: user visit the affiliate portal
    ...
    Scenario: user should be able to login with phone number
    ...
    # Scenario: user should be able to switch profile between investor and admin
    ...
    Scenario: user can see contact innformation upon clicking contatc us button
